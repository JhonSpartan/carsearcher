...
import {Box, Drawer, List, ListItem, Divider, ListItemButton, ListItemIcon, ListItemText, Typography, Tooltip, Avatar, IconButton, LinearProgress} from '@mui/material'
import { Dashboard, DirectionsCar, Logout } from '@mui/icons-material';
              ...
              >
                <ListItemButton sx={{display: 'flex', justifyContent: {xl: 'unset', xs: 'center'}}}>
                  <ListItemIcon sx={{position: 'relative', display: {lg: 'block', xs: 'flex'}, justifyContent: {xl: 'unset', xs: 'center'}}}>
                    ...
                    { item.path === '/messages' ? <Box>{children}</Box> : <></>}
                  </ListItemIcon>
